...
export type ReportSection = 'all' | 'executive_summary' | 'hiring_activity' | 'workforce_composition' | 'category_intelligence' | 'geographic_intelligence' | 'competitive_intelligence' | 'strategic_insights' | 'appendix';
...
export declare const AGENCY_COLORS: Record<string, string>;
