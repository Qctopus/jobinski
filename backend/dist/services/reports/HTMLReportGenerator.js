...
const monthlyReport_1 = require("../../types/monthlyReport");
class HTMLReportGenerator {
    generateHTMLReport(data) {
        const brandColors = monthlyReport_1.AGENCY_BRAND_COLORS[data.agency.shortName] || monthlyReport_1.AGENCY_BRAND_COLORS['default'] || { primary: '#009EDB', secondary: '#00477E' };
        return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <script>
    ...
    *, *::before, *::after {
    ...
    generateMarketPositionSection(data) {
    ...
    generateTemporalTrendsSection(data) {
    ...
    generateMarketShareTrendScript(data) {
    ...
    generatePositioningScatterScript(data) {
        const matrix = data.competitive.positioningMatrix || [];
        const colors = monthlyReport_1.AGENCY_BRAND_COLORS[data.agency.shortName] || monthlyReport_1.AGENCY_BRAND_COLORS['default'] || { primary: '#009EDB', secondary: '#00477E' };
        return `
    ...
    generatePostedVsOpenScript(data) {
    ...
    generateWindowComparisonScript(data) {
    ...
    generateWorkforcePyramidScript(data) {
    ...
    generateSeniorityTrendScript(data) {
    ...
    generateContractTypeScript(data) {
    ...
    generateGeoDistributionScript(data) {
    ...
    generateCategoryTimelineScript(data) {
    ...
    generateSkillBubbleScript(data) {
    ...
    generateLanguageChartScript(data) {
    ...
    generateTalentWarZoneScript(data) {
    ...
    generateSeasonalHeatmapScript(data) {
...
exports.default = HTMLReportGenerator;
