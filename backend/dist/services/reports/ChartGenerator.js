...
class ChartGenerator {
    generateAllCharts(metrics, benchmarks, competitive) {
        return {
    ...
    generatePostingTrendChart(metrics) {
    ...
    generateGradeDistributionChart(metrics) {
    ...
    generateCategoryDistributionChart(metrics) {
    ...
    generateGeographicDistributionChart(metrics) {
    ...
    generateStaffTypeChart(metrics) {
